...
# premixed turbulent gasoline-air
equiv_ratio = 1.0
T_u = 500  # K, reactant temperature
P_u = 1*101325  # Pa, pressure
u_rms = 25/3  # m/s, rms turbulence velocity
l_0 = 0.0025  # m, turbulence integral length scale
dynamic_viscosity_u = 270.1e-7  # Ns/m^2, Table C.1 at 500K
# correction for pressure (p ref / p unburned)
alpha = (1/1)*56.7e-6  # m^2/s, Table C.1 at 500K, thermal diffusivity
...
Re_l_0 = (rho_air*u_rms*l_0)/dynamic_viscosity_u
print(f"{Re_l_0 = }")
